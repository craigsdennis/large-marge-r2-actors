/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b4f5e04e8e203837333f2e5ec7e607c9)
// Runtime types generated with workerd@1.20250712.0 2025-07-01 global_fetch_strictly_public
declare namespace Cloudflare {
	interface Env {
		AUTH_SECRET: string;
		Uploader: DurableObjectNamespace<import("./src/index").Uploader>;
		BIGGIES: R2Bucket;
	}
}
